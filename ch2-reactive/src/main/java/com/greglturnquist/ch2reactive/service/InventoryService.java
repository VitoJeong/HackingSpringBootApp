package com.greglturnquist.ch2reactive.service;

import com.greglturnquist.ch2reactive.Item;
import com.greglturnquist.ch2reactive.repository.ItemByExampleRepository;
import com.greglturnquist.ch2reactive.repository.ItemRepository;
...
public class InventoryService {
    ...
    // MongoDB의 평문형 연산기능을 사용하기 위한 인터페이스
    ...
    public Flux<Item> searchByExample(String name, String description, boolean useAnd) {
        ...
        ExampleMatcher matcher = (useAnd
                ...
                .withIgnoreCase()
                // 기본 타입에는 null이 올 수 없으므로 명시적으로 무시되도록 지정
                .withIgnorePaths("price").withIgnorePaths("availableUnits")
